...
module.exports = {
	...
	groupA_preset: [
		{ id: 0, label: 'Preset Off' },
		{ id: grpAval, label: 'Preset On' },
		{ id: toggle, label: 'Toggle' },
		{ id: noChange, label: 'No Change' },
	],
	groupB_preset: [
		{ id: 0, label: 'Preset Off' },
		{ id: grpBval, label: 'Preset On' },
		{ id: toggle, label: 'Toggle' },
		{ id: noChange, label: 'No Change' },
	],
	groupC_preset: [
		{ id: 0, label: 'Preset Off' },
		{ id: grpCval, label: 'Preset On' },
		{ id: toggle, label: 'Toggle' },
		{ id: noChange, label: 'No Change' },
	],
	groupA_override: [
		{ id: 0, label: 'Normal' },
		{ id: grpAval, label: 'Override On' },
		{ id: toggle, label: 'Toggle' },
		{ id: noChange, label: 'No Change' },
	],
	groupB_override: [
		{ id: 0, label: 'Normal' },
		{ id: grpBval, label: 'Override On' },
		{ id: toggle, label: 'Toggle' },
		{ id: noChange, label: 'No Change' },
	],
	groupC_override: [
		{ id: 0, label: 'Normal' },
		{ id: grpCval, label: 'Override On' },
		{ id: toggle, label: 'Toggle' },
		{ id: noChange, label: 'No Change' },
	],
	groupA_lasthold: [
		{ id: 0, label: 'Last Hold Off' },
		{ id: grpAval, label: 'Last Hold On' },
		{ id: toggle, label: 'Toggle' },
		{ id: noChange, label: 'No Change' },
	],
	groupB_lasthold: [
		{ id: 0, label: 'Last Hold Off' },
		{ id: grpBval, label: 'Last Hold On' },
		{ id: toggle, label: 'Toggle' },
		{ id: noChange, label: 'No Change' },
	],
	groupC_lasthold: [
		{ id: 0, label: 'Last Hold Off' },
		{ id: grpCval, label: 'Last Hold On' },
		{ id: toggle, label: 'Toggle' },
		{ id: noChange, label: 'No Change' },
	],
	system_defaults: [
